...
class RoamingRalphDemo(ShowBase):
    def __init__(self):
        ...
        newfireSystem = fireSystem(0, "blueFire")
        newfireSystem.reparentTo(self.ralph)
        newfireSystem.setPos(0,0,5)
        self.fireManager.addFireSystem(newfireSystem)
		
        self.teapot = self.loader.loadModel("teapot")
        self.teapot.reparentTo(render)
        self.teapot.setPos(-107,10,-3.5)
        self.teapot.setScale(1,1,1)
        
        fireSystem2 = fireSystem(1, "yellowFire")
        fireSystem2.reparentTo(self.teapot)
        fireSystem2.setPos(0,0,1.5)
        self.fireManager.addFireSystem(fireSystem2)
        fireSystem2.ignite()
